    ...
    return (
        <div className="post__item">
            <div className="post__header">
                ...
                <FaEllipsisH className="more__icon"></FaEllipsisH>
            </div>
            <div className="post__text__box"><span>{text}</span></div>
            ...
            <div className="post__interactions__box">
                <div className="post__interaction__emoji">
                    {
                        emojis.map(
                            emoji => 
                            <div className="interaction__emoji">
                                <img src={return_emoji(emoji)} alt={emoji}></img>
                            </div>
                        )
                    }
                    <span>{emojis_number}</span>
                </div>
                <div className="post__sharings">
                    <span>{comments_number} comments</span>
                    <span>{share_number} shares</span>
                </div>
            </div>
